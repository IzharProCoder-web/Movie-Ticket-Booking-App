  ...
  return show ? (
    <div className="px-6 md:px-16 lg:px-40 pt-30 md:pt-50">
      <div className="flex items-center justify-center gap-5">
          ...
          <img src={show.movie.poster_path} className="w-70 h-104 max-md:mx-auto rounded-xl object-cover " />
      ...
      <div className="overflow-x-auto no-scrollbar mt-8 pb-4">
        <div className="flex  items-center gap-4 w-max px-4">
          ...
          <button onClick={() => {navigate('/movies'); scrollTo(0,0)}}  className="text-center bg-primary hover:bg-primary-dull px-7 py-2 rounded">Show More</button>
           </div>
